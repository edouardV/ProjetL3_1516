...
public class Bruler extends Interaction<VuePersonnage> {
	...
	/**
	 * Cree une interaction de coup critique.
	 * @param arene arene
	 * @param attaquant attaquant
	 * @param defenseur defenseur
	 */
	public Bruler(Arene arene, VuePersonnage attaquant, VuePersonnage defenseur) {
	...
	public void interagit() {
		try {
			...
			// brulure (+5)
			defenseur.getElement().setBrulure((defenseur.getElement().getBrulure())+5);
				
			logs(Level.INFO, Constantes.nomRaccourciClient(attaquant) + " provoque une brulure a " 
